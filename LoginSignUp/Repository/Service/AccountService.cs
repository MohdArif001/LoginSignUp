...
namespace LoginSignUp.Repository.Service
{
    public class AccountService :IUsers
    {
        ...
        private void SendMail(string to, string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("akilraza1132@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("akilraza1132@gmail.com", "12akil.."); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
        }
